...
The Central Bank's **DhowCSD** platform is the structural change. By letting individuals open a CDS account and bid for Treasury Bills and Bonds directly from a phone, it removes the gatekeeper. A teacher in Nakuru or a nurse in Mombasa can now lend to the government on broadly the same terms as a bank.

That sounds technical, but the social effect is large: it lets the **middle class earn the sovereign rate** instead of paying it away in fees and low deposit returns.
...
A large part of the conversation was the **diaspora**. Kenyans abroad send home enormous remittance flows, much of which lands in consumption or idle accounts. Simplifying digital bidding routes so overseas Kenyans can put part of that into sovereign instruments — earning a strong, tax-advantaged local yield — was seen as one of the highest-impact opportunities on the table.
