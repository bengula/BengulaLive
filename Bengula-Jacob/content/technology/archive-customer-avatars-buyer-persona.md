...
summary: A practical guide to creating customer avatars and buyer personas with research, segmentation, interview data, analytics, and conversion-focused messaging.
...
| --- | --- |
| Persona name | A memorable working name |
| Segment | The customer group this persona represents |
| Goal | What they are trying to achieve |
| Pain points | What frustrates or blocks them |
| Objections | Why they may hesitate |
| Decision trigger | What makes them start looking now |
| Source of information | Where they learn and compare |
| Preferred message | The wording that resonates |
...
- [HubSpot guide to buyer persona research](https://blog.hubspot.com/marketing/buyer-persona-research)
- [Mailchimp guide to segmentation](https://mailchimp.com/resources/beginners-guide-to-segmentation/)
- [Mailchimp pre-built segments overview](https://mailchimp.com/help/about-pre-built-segments/)
