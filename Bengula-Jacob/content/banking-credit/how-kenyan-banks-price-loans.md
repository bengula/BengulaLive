---
id: how-kenyan-banks-price-loans
title: "How Kenyan Banks Price Your Loan: The Base Rate Plus 'K' Margin Explained"
summary: Two people can walk into the same bank, ask for the same loan, and be quoted very different rates. Under Kenya's risk-based credit pricing framework, your rate is a base rate plus a bank-set "K" margin built from real cost components. Here is exactly what goes into that number, and the levers you actually control.
...
coverImage: https://images.pexels.com/photos/209224/pexels-photo-209224.jpeg?auto=compress&cs=tinysrgb&w=1600
---

![A calculator and pen resting on a table of figures](https://images.pexels.com/photos/209224/pexels-photo-209224.jpeg?auto=compress&cs=tinysrgb&w=1200 "Your loan rate is not plucked from the air: it is a base rate plus a margin built from costs and your own risk. Photo: Pexels")
...
The **base rate** is a public reference rate. Most banks anchor it to the **Central Bank Rate (CBR), which the CBK held at 8.75% (effective 10 February 2026** and through the April 2026 review, per [CBK](https://www.centralbank.go.ke/rates/)). Because the base rate is published and common to all borrowers at that bank, it is not where the difference between two customers comes from.
...
That migration has since been formalised. Under CBK's revised Risk-Based Credit Pricing Model, covered facilities now price off KESONIA or the CBR by the bank's choice, banks must publish the K margin by product and risk band, and existing loans were transitioned onto the new structure. The transition rules, the list of which loans are covered and which are excluded, and how to use the Total Cost of Credit portal to compare lenders are covered in [KESONIA, CBR, and the Revised Risk-Based Credit Pricing Model](/blog/risk-based-credit-pricing-kesonia-cbr-kenya).
...
- **Compare the all-in cost, not the headline rate.** Negotiation fees, valuation, and insurance lift the true APR. The CBK and Kenya Bankers Association publish every bank's total cost of credit at [costofcredit.co.ke](https://www.costofcredit.co.ke/), so you can benchmark before you sign.
...
- [Total Cost of Credit (CBK and Kenya Bankers Association)](https://www.costofcredit.co.ke/). Compare every bank's published APR and fees before borrowing.
- [Absa Bank Kenya Business Banking](https://www.absabank.co.ke/business/). Used as an illustrative worked example of a bank's risk-based pricing.
