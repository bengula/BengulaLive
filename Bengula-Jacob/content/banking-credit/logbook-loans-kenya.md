---
id: logbook-loans-kenya
title: "Logbook Loans in Kenya: What the Rate Really Costs and What Default Looks Like"
summary: "A logbook loan turns the car you already own into cash in days, and it is priced and enforced quite unlike any other loan a Kenyan household takes. This guide covers what you actually sign, how a 3% monthly quote becomes a 61% annual rate, the total cost hiding outside the interest line, the repossession timeline the law really allows, and the fork where asset finance is the better instrument."
...
coverImage: https://loremflickr.com/1600/900/car,loan?lock=2013
---

![A hand holding a set of car keys](https://images.pexels.com/photos/97079/pexels-photo-97079.jpeg?auto=compress&cs=tinysrgb&w=1200 "You keep the keys and you keep driving. What changes is the legal interest registered against the vehicle, and that interest is what makes recovery fast. Photo: Pexels")
...
![Car keys being handed across a signed document](https://images.pexels.com/photos/8482859/pexels-photo-8482859.jpeg?auto=compress&cs=tinysrgb&w=1200 "The logbook loan is a paperwork transaction, not a key transaction. Read the security agreement, not just the offer letter. Photo: Pexels")
...
```mermaid
flowchart TD
  A["Instalments missed, arrears accrue"] --> B["Lender moves to recover"]
  B --> C["Possession taken, s.71<br/>No court order where you consented in the agreement"]
  C --> D["Vehicle held; enforcement costs begin accruing"]
  D --> E["Notice of intended disposal, s.73<br/>At least 5 working days before sale"]
  E --> F{"Redeem under s.69?"}
  F -->|"Pay full balance plus costs before the sale"| G["Vehicle released to you"]
  F -->|"No"| H["Sale, in a commercially reasonable manner"]
  H --> I["Proceeds applied: costs, then debt, then junior creditors"]
  I --> J["Surplus returned to you<br/>Any shortfall still owed, s.74(4)"]
```
