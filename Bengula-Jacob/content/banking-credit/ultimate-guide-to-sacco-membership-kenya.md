---
id: ultimate-guide-to-sacco-membership-kenya
title: "The Ultimate Guide to SACCO Membership in Kenya"
summary: "Most SACCO guides stop at loans. This one covers everything else: what share capital actually buys you, why your deposits are not savings you can withdraw, how dividends and interest rebates are really declared, nominating a beneficiary, voting at the AGM, and the two processes nobody explains until you need them, exiting a SACCO and what happens if one fails."
...
coverImage: https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg?auto=compress&cs=tinysrgb&w=1600
---

![Members meeting around a table with documents](https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg?auto=compress&cs=tinysrgb&w=1200 "A SACCO member is an owner, not a customer. The difference shows up at the AGM and on the way out. Photo: Pexels")
...
```mermaid
flowchart TD
  M["Member contribution"] --> SC["Share capital<br/>Ownership + dividend"]
  M --> BD["BOSA deposits<br/>Non-withdrawable<br/>Borrowing base"]
  M --> FS["FOSA savings<br/>Withdrawable"]
  BD --> LC["Loan capacity<br/>Multiple of deposits"]
  SC --> V["Voting right<br/>One member, one vote"]
  LC --> L["Loan"]
  L --> G["Guarantors pledged"]

  style SC fill:#8b5cf6,color:#fff,stroke:none
  style BD fill:#0f172a,color:#fff,stroke:none
  style FS fill:#22c55e,color:#fff,stroke:none
...
```mermaid
flowchart TD
  N["Give written notice"] --> L{"Outstanding loan?"}
  L -->|"Yes"| O["Offset against deposits"]
  L -->|"No"| G
  O --> G{"Guaranteeing live loans?"}
  G -->|"Yes"| S["Find substitute guarantor<br/>Exit blocked until released"]
  G -->|"No"| SH{"Share capital"}
  S --> SH
  SH --> T["Transfer to another member<br/>or refund per by-laws"]
  T --> R["Balance refunded<br/>subject to notice period"]

  style S fill:#f59e0b,color:#fff,stroke:none
  style R fill:#22c55e,color:#fff,stroke:none
  style N fill:#0f172a,color:#fff,stroke:none
```
