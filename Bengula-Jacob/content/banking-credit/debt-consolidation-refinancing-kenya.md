---
id: debt-consolidation-refinancing-kenya
title: "Debt Consolidation and Loan Refinancing in Kenya: Collapsing Expensive Debts Into One Survivable One"
summary: Most Kenyan debt distress is not too much borrowing; it is too many borrowings, at mismatched prices, on colliding schedules. This guide covers when consolidation genuinely saves money and when it just feels better, the buy-off mechanics banks and SACCOs use, the refinancing case in a falling KESONIA cycle, the tenor trap that makes cheaper monthly payments cost more in total, and the arithmetic to run before signing anything.
...
| Debt | Balance | Effective Annual Cost | Monthly Interest Burden |
|---|---|---|---|
| Mobile loans (three apps, rolling) | KES 120,000 | ~60% | ~KES 6,000 |
| Credit card (revolving at ~3.5%/month) | KES 150,000 | ~42% | ~KES 5,250 |
| Bank personal loan | KES 400,000 | 16% | ~KES 5,300 |
| **Total** | **KES 670,000** | **~30% blended** | **~KES 16,550** |
...
The same trap wears business clothing in [the SME handbook's restructuring playbook](/blog/sme-finance-handbook-kenya): re-terming is medicine, and medicine has dosage.
...
1. **Settlement figures first.** You request formal, dated settlement letters from each existing lender: exact payoff amounts, valid-to dates, and any early-settlement terms. (Check those terms; the [interest-rate guide](/blog/mobile-loan-vs-bank-loan-apr-breakdown) covers why some facilities charge for leaving and some recalculate in your favour.)
...
4. **Check-off loans have one extra gear**: employer payroll instructions must be cancelled and re-established, and one overlapping month of double deduction is a known, recoverable, but budget-wrecking surprise; plan for it. How payroll-deduction lending is priced and compared, and the full anatomy of that double-deduction month, is covered in [check-off and salary loans](/blog/check-off-salary-loans-kenya).
...
**Where to consolidate:** banks (personal and check-off loans are the standard vehicle), SACCOs (often the cheapest rate a member can access, backed by deposits and the multiplier covered in [the savings guide](/blog/bank-vs-sacco-vs-mmf-savings)), and, for salaried staff, employer-scheme loans. The correct choice is almost always the cheapest *reducing-balance* rate your file commands, from an institution that reports to the bureaus, because the consolidation loan is also the flagship exhibit of your rebuilt file.
...
$$ \text{Break-even (months)} = \frac{\text{All switching costs}}{\text{Monthly saving}} $$

Total the true switching costs, new facility fees plus excise, any early-settlement charge, legal and registration fees where security migrates, and divide by the honest monthly saving. Break-even under a year with meaningful loan life remaining: refinance. Break-even beyond half the remaining tenor: you are redecorating, not saving. The fee anatomy that feeds the numerator is itemised in [Understanding Interest Rates in Kenya](/blog/mobile-loan-vs-bank-loan-apr-breakdown), and comparisons belong on the [Total Cost of Credit portal](https://www.costofcredit.co.ke/) before any signature.
...
- **Guarantor entanglement**: consolidating SACCO debt affects the guarantors who signed for it; release and re-guarantee mechanics come first ([their position](/blog/sacco-savers-guarantors)).
...
- [Central Bank of Kenya](https://www.centralbank.go.ke/): KESONIA (8.7505%, 2 July 2026) and the risk-based pricing framework.
- [Total Cost of Credit portal](https://www.costofcredit.co.ke/): comparing the consolidation offer against the market.
- Bengula Inc: [Understanding Interest Rates in Kenya](/blog/mobile-loan-vs-bank-loan-apr-breakdown), [Your Credit Score in Kenya](/blog/credit-score-kenya-guide), [How to Fix Your CRB Listing](/blog/how-to-fix-your-crb-listing-kenya), [Safe for Savers, Risky for Guarantors](/blog/sacco-savers-guarantors), [The Complete SME Finance Handbook](/blog/sme-finance-handbook-kenya)
