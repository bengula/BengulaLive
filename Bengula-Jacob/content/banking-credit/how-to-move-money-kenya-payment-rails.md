---
id: how-to-move-money-kenya-payment-rails
title: "How to Move Money in Kenya: M-Pesa, PesaLink, EFT, RTGS, and TT Compared"
summary: "Every payment you make travels on one of five rails, and picking the wrong one costs you money, time, or the ability to get it back. This guide compares M-Pesa, PesaLink, EFT, RTGS, and international TT on speed, cost, limits, cut-off times, and reversibility, then gives a simple decision tree so the right rail is obvious before you press send."
...
![Hands counting cash beside a card terminal](https://images.pexels.com/photos/4968630/pexels-photo-4968630.jpeg?auto=compress&cs=tinysrgb&w=1200 "Cash is now the exception, not the rule. The question has shifted from whether to pay digitally to which digital rail carries the payment best. Photo: Pexels")
...
```mermaid
flowchart TD
  A["I need to pay someone"] --> B{"Domestic or<br/>international?"}
  B -->|"International"| T["TT / SWIFT<br/>compare the all-in FX rate,<br/>not just the fee"]
  B -->|"Domestic"| C{"How large?"}
  C -->|"Small, within the<br/>M-Pesa limit"| D{"Recipient on<br/>mobile money?"}
  D -->|"Yes"| E["M-Pesa<br/>instant, reversible if not withdrawn"]
  D -->|"No, bank account"| F["PesaLink<br/>instant, bank-to-bank"]
  C -->|"Mid-size<br/>(up to ~1M)"| G{"Urgent?"}
  G -->|"Yes"| F
  G -->|"No"| H["EFT<br/>cheapest, same/next day"]
  C -->|"Large<br/>(1M and above)"| I["RTGS / KEPSS<br/>same-day, final: verify the account twice"]
```
...
![A payslip and calculator on a desk](https://images.pexels.com/photos/4386366/pexels-photo-4386366.jpeg?auto=compress&cs=tinysrgb&w=1200 "Payroll is the clearest case for matching rail to purpose: twenty salaries belong in one cheap EFT batch, not twenty individual instant transfers. Photo: Pexels")
