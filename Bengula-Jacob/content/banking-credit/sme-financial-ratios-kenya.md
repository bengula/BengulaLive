---
id: sme-financial-ratios-kenya
title: "Financial Ratios Every SME Owner Should Know: The Seven Numbers That Explain Your Business"
summary: "Your accounts hold the answer to almost every question you have about your business, but only if you know which numbers to divide by which. This guide walks seven ratios that turn a set of statements into a diagnosis: gross and net margin, the current ratio, leverage, return on assets and equity, and the cash conversion cycle, each with a formula and a single worked Kenyan example you can copy straight into your own spreadsheet."
...
$$ \text{Net Margin} = \frac{\text{Net Profit}}{\text{Revenue}} \times 100 = \frac{1{,}200{,}000}{12{,}000{,}000} \times 100 = 10\% $$

Mama Chai keeps ten shillings of every hundred it sells. The gap between the 35% gross margin and the 10% net margin, twenty-five points, is the entire cost of running the business: overheads and financing. When net margin falls while gross margin holds steady, your product is still sound but your overheads or interest bill are eating the difference, a signal to look at costs and at what your [loans are actually costing you](/blog/how-kenyan-banks-price-loans). Net margin is also the number that turns growth into wealth: doubling revenue at a 2% margin is exhausting and fragile; a 10% margin makes the same growth worth having.
...
$$ \text{Current Ratio} = \frac{\text{Current Assets}}{\text{Current Liabilities}} = \frac{3{,}000{,}000}{2{,}000{,}000} = 1.5 $$
...
$$ \text{Quick Ratio} = \frac{\text{Current Assets} - \text{Inventory}}{\text{Current Liabilities}} = \frac{3{,}000{,}000 - 1{,}000{,}000}{2{,}000{,}000} = 1.0 $$

Mama Chai's quick ratio of 1.0 says that even if it could not sell a single item of stock, it could still just cover its short-term debts from cash and receivables. If your current ratio looks healthy but your quick ratio is weak, your liquidity is trapped in inventory, and the fix lives in [managing your receivables and stock](/blog/what-is-accounts-receivable).
...
$$ \text{ROA} = \frac{\text{Net Profit}}{\text{Total Assets}} \times 100 = \frac{1{,}200{,}000}{8{,}000{,}000} \times 100 = 15\% $$
...
$$ \text{ROE} = \frac{\text{Net Profit}}{\text{Owner's Equity}} \times 100 = \frac{1{,}200{,}000}{4{,}800{,}000} \times 100 = 25\% $$

A 25% return on equity is strong, and it is the number to hold against your alternatives. If your business returns 25% on your capital, it is comfortably beating a [T-bill ladder](/blog/advanced-dhowcsd-t-bill-ladder) or a [money market fund](/blog/future-mmfs-kenya); if it ever returns less than those safe, passive options, you are being paid too little for the risk and effort of running it, and that is a genuine strategic question, not a failure. Note the gap between Mama Chai's ROA (15%) and ROE (25%): that difference is the effect of leverage. Borrowing has amplified the owner's return, which is exactly why lenders and owners read the debt-to-equity ratio alongside ROE, never on its own.
...
For 35 days, Mama Chai's cash is locked up in the business before a sale finally returns it. Every day you shave off, by holding less stock, collecting faster, or negotiating longer supplier terms, is a day of working capital freed without borrowing a shilling. This is the single highest-leverage operational number in most SMEs, and it is the organising idea behind [the whole SME finance handbook](/blog/sme-finance-handbook-kenya); the collection half is covered in depth in [accounts receivable](/blog/what-is-accounts-receivable).
...
### References
- [Central Bank of Kenya](https://www.centralbank.go.ke/). Banking and macroeconomic context against which business performance is read.
- [Kenya Revenue Authority](https://www.kra.go.ke/). Accurate records and tax compliance are the foundation of reliable ratios.
- Bengula Inc: [What Is Accounts Receivable](/blog/what-is-accounts-receivable), [The Complete SME Finance Handbook](/blog/sme-finance-handbook-kenya), [The Anatomy of a Perfect Bank Proposal](/blog/anatomy-of-a-bank-proposal-kenya), [SME Packager Margin Optimisation](/blog/sme-packager-optimization), [How to Build an Accurate Startup Budget](/blog/how-to-build-an-accurate-startup-budget).
