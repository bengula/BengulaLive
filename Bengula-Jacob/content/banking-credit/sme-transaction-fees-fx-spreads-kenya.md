---
id: sme-transaction-fees-fx-spreads-kenya
title: "The Hidden Leak: How Kenyan SMEs Bleed Money on Fees and FX Spreads"
summary: "Interest rates get the attention; tariffs and foreign-exchange spreads often take more cash. This guide shows how to read a corporate tariff guide, spot the margin inside a USD/KES quote, run a fee audit, and negotiate like a customer who knows where the bank actually earns."
...
```mermaid
flowchart LR
  A["Pull statements<br/>and FX tickets"] --> B["Classify leaks<br/>by bucket"]
  B --> C["Annualise<br/>material lines"]
  C --> D{"Behaviour or<br/>pricing problem?"}
  D -->|Behaviour| E["Change process:<br/>cash, batching, tenor"]
  D -->|Pricing| F["RM negotiation<br/>with evidence pack"]
  E --> G["Re-measure<br/>next quarter"]
  F --> G
```
...
- Bengula Inc: [How Banks Actually Make Money](/blog/how-banks-actually-make-money-kenya), [How to Move Money in Kenya: Payment Rails Compared](/blog/how-to-move-money-kenya-payment-rails), [M-Pesa for Business: Pay Bill vs Buy Goods](/blog/mpesa-for-business-paybill-till-kenya), [Hedging USD/KES](/blog/usd-shilling-hedging), [Ultimate Guide to Banking in Kenya](/blog/ultimate-guide-to-banking-in-kenya), [Import Finance in Kenya](/blog/import-finance-kenya-guide), [Bank Guarantees for SMEs](/blog/bank-guarantees-kenya-sme-guide), [SME Finance Handbook](/blog/sme-finance-handbook-kenya), [Why Your RM Is a Growth Asset](/blog/why-rm-is-sme-growth-asset).
