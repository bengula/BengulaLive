---
id: hire-purchase-vs-asset-finance-vs-logbook-kenya
title: "Hire Purchase vs Asset Finance vs Logbook: Buying the Asset Without the Wrong Debt"
summary: "Three products can put a vehicle or machine in your yard, and they are not interchangeable. Hire purchase, asset finance, and a logbook loan differ on who owns the asset while you pay, how the rate is quoted, what deposit you need, and what default costs. This guide sets them side by side, converts a flat hire-purchase quote into its real annual cost, and gives a clean rule for which one fits your situation."
...
coverImage: https://loremflickr.com/1600/900/car,finance?lock=2011
---

![A hand holding a set of car keys](https://images.pexels.com/photos/97079/pexels-photo-97079.jpeg?auto=compress&cs=tinysrgb&w=1200 "The same set of keys can be bought with three quite different debts. The one you choose decides who owns the asset while you pay, and what a bad month costs you. Photo: Pexels")
...
![Car keys being handed across a signed document](https://images.pexels.com/photos/8482859/pexels-photo-8482859.jpeg?auto=compress&cs=tinysrgb&w=1200 "Under hire purchase the keys are yours but the ownership is not, not until the final instalment clears. Read which of the three structures you are actually signing. Photo: Pexels")
...
```mermaid
flowchart TD
  A["I need this asset"] --> B{"Do I already own<br/>a suitable asset outright?"}
  B -->|"No, I am acquiring it"| C{"Can I find a<br/>10-20% deposit?"}
  B -->|"Yes, and I only need cash"| L["Logbook loan<br/>short, defined, repayable event only"]
  C -->|"Yes"| D["Asset finance<br/>reducing balance, matched tenor"]
  C -->|"No / thin bank history"| E{"Dealer hire-purchase total,<br/>after converting the flat rate,<br/>beats asset finance?"}
  E -->|"Yes"| F["Hire purchase"]
  E -->|"No"| D
  D --> G{"Avoiding conventional interest?"}
  F --> G
  G -->|"Yes"| H["Ask for murabaha / ijara<br/>and compare the total price"]
  G -->|"No"| I["Proceed on the cheapest total cost of credit"]
```
