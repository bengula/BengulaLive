---
id: banking-as-a-service-kenya-baas-guide
title: "Banking-as-a-Service in Kenya: The Complete Guide (2026 Edition)"
summary: Banking-as-a-Service (BaaS) is restructuring Kenya's financial stack, letting fintechs, SACCOs, and platforms deliver regulated banking products without a banking licence. This guide covers how the ecosystem works, who the key players are, which core banking systems power it, and what to check before committing to a BaaS partner.
...
coverImage: https://images.pexels.com/photos/5077047/pexels-photo-5077047.jpeg?auto=compress&cs=tinysrgb&w=1600
---
...
[Licensed digital credit providers (DCPs) regulated by the CBK grew from 52 in mid-2024 to 85 in the first half of 2025](https://saccoreview.co.ke/kenyas-banking-sector-shows-resilience-despite-tight-lending-and-rising-credit-risks-cbk-2024-2025-report/), a 63% jump in under twelve months. [On July 1, 2025, CBK lifted the moratorium on licensing new commercial banks that had been in place since November 2015, opening the door for greenfield applicants for the first time in a decade.](https://cytonnreport.com/topicals/kenya-listed-banks-25)

At the same time, traditional banks face a margin squeeze. [Commercial lending rates sit at 13â€“18% for SMEs under the new risk-based pricing framework anchored on KESONIA (Kenya Shilling Overnight Interbank Average), which CBK introduced in August 2025 to replace the Central Bank Rate as the benchmark for variable-rate loans.](https://cytonnreport.com/topicals/kenya-listed-banks-25) Banks that want to grow revenue without simply adding branches are moving into BaaS, opening their infrastructure to fintechs and platforms rather than competing against them.

[Over 80% of Kenya's adult population now has access to formal financial services, up from approximately 26% in 2006](https://hudumaglobal.com/blog/banking-kenya-commercial-banks-digital-banks-financial-services-2025), largely through digital channels. The next frontier isn't financial inclusion in the basic access sense. It's depth: savings products, credit, insurance, and investment tools delivered inside platforms people already use daily.
...
**Augmented offerings.** Banks and aggregators combine existing products to create bundled financial solutions, a logistics platform that adds invoice financing, for instance, or a SACCO that adds insurance through a bank partner.
...
**Craft Silicon** serves over 254 financial institutions across Africa and completed 58 fintech projects in 2025 alone. It provides core banking software and BaaS middleware, particularly relevant to tier-2 and tier-3 Kenyan banks looking to launch digital products without building technology from scratch.
...
[Following a $3 million seed extension and an exclusive digital solutions agreement with KUSCCO (the Kenya Union of Savings & Credit Cooperatives, the national umbrella body), Kwara gained connections to a pool of over 4,000 SACCOs for its BaaS offering.](https://techcrunch.com/2023/01/16/kenyan-fintech-kwara-raises-3m-seed-extension-signs-deal-to-reach-over-4000-credit-unions/) It also [wholly acquired IRNET Coop Kenya, a software company and KUSCCO subsidiary, embedding its technology into the existing SACCO cooperative network across the country.](https://disruptafrica.com/2023/01/16/kenyan-fintech-startup-kwara-acquires-software-company-partners-sacco-union/)

[Kwara now serves more than 230 credit unions across four countries and over 200,000 end clients. In 2023 alone, the platform managed an annual transaction volume of EUR 1 billion.](https://fintechnews.africa/44251/fintech-kenya/top-10-fintech-startups-in-kenya-in-2024/) Its neobank app grew its user base 35-fold between 2022 and 2023.
...
[In December 2024, Kenya enacted the Business Laws (Amendment) Act, which expanded CBK's mandate to include regulation of non-deposit taking credit providers, requiring foreign lenders to register locally and obtain CBK licenses before lending to Kenyan entities.](https://practiceguides.chambers.com/practice-guides/banking-finance-2025/kenya/trends-and-developments) This has tightened access to offshore capital but also clarified the regulatory perimeter: any entity in the credit chain needs to be within CBK's sight.

[New minimum core capital requirements mandate KES 10 billion by December 2029, up from KES 1 billion previously](https://practiceguides.chambers.com/practice-guides/banking-finance-2025/kenya/trends-and-developments), a deliberate consolidation move that will push weaker banks toward mergers, and may accelerate BaaS adoption as smaller banks seek revenue without needing to scale capital-intensive balance sheets.
...
**Liability allocation.** When a BaaS-delivered product fails, a missed payment, a fraud event, a system outage, who is liable to the customer? The bank (license holder) or the platform (customer relationship owner)? This needs explicit contractual resolution, not assumption.
...
**Regulatory clarity on data.** Confirm the bank's data sharing posture under CBK's evolving framework. Don't assume, document it in the partnership terms.

**Capital adequacy of the bank partner.** [CBK's stress tests warn that up to 12 banks, mainly tier-3, could be undercapitalized under adverse scenarios](https://cytonnreport.com/topicals/kenya-listed-banks-25). A bank partner that gets downgraded or forced into a merger mid-partnership is an operational and reputational risk to your product. Stick with tier-1 and well-capitalized tier-2 partners for any serious BaaS arrangement.
...
*Jacob Bengula is a Relationship Manager at Absa Bank Kenya and Founder of Bengula Inc., a finance and business advisory platform. Connect on [bengula.co.ke](https://bengula.co.ke).*
