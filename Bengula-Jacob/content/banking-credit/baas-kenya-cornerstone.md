...
At the same time, traditional banks face a margin squeeze. [Commercial lending rates sit at 13–18% for SMEs under the new risk-based pricing framework anchored on KESONIA (Kenya Shilling Overnight Interbank Average), which CBK introduced in August 2025 to replace the Central Bank Rate as the benchmark for variable-rate loans.](https://cytonnreport.com/topicals/kenya-listed-banks-25) Banks that want to grow revenue without simply adding branches are moving into BaaS, opening their infrastructure to fintechs and platforms rather than competing against them.
