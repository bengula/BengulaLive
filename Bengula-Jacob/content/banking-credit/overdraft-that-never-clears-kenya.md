---
id: overdraft-that-never-clears-kenya
title: "The Overdraft That Never Clears: How Float Becomes Permanent Debt"
summary: "An overdraft is the most flexible facility a Kenyan business can hold and the most commonly mispurchased. This guide covers how overdraft interest actually accrues on daily utilisation, the clean-down covenant most owners have never read, the statement pattern that tells a lender your overdraft has become a term loan in disguise, and the arithmetic of converting it before your next annual review does it for you."
...
For where the overdraft sits among the alternatives, see [the complete guide to borrowing money in Kenya](/blog/borrowing-money-in-kenya-guide) and [the SME finance handbook](/blog/sme-finance-handbook-kenya).
...
```cards
- icon: Activity
  title: Interest is a daily count
  desc: You are charged on the balance actually drawn each day, not on your limit. That is the feature, and the trap.
- icon: LineChart
  title: Run the zero test
  desc: Pull twelve months of statements. If the account never touched credit, your overdraft is term debt wearing a costume.
  type: amber
- icon: ArrowRightLeft
  title: Convert before review
  desc: Terming out a hardcore balance is cheaper than carrying it, and far cheaper than a facility withdrawn at review.
  linkText: Refinancing options
  linkUrl: /blog/debt-consolidation-refinancing-kenya
  type: emerald
```
...
$$
\text{Interest} = \sum_{d=1}^{n} \left( \text{Utilised balance}_d \times \frac{\text{Annual rate}}{365} \right)
$$
...
|---|---|---|
| Customers pay 60 days, suppliers want 30 | [Invoice discounting or factoring](/blog/what-is-accounts-receivable) | Finance follows the specific receivable and self-liquidates on payment |
| A confirmed order needs stock funding | [LPO and purchase order finance](/blog/lpo-purchase-order-finance-kenya) | Tied to the order, repaid from its proceeds |
| Buying a vehicle or equipment | [Asset finance](/blog/asset-finance-vs-conventional-loans) | Secured on the asset, longer tenor, cheaper |
...
**Bring the evidence.** A restructure request is a credit application. It needs current management accounts, twelve months of statements, an explanation of what drove the hardcore build-up, and a credible account of why it will not rebuild. The preparation is set out in [the anatomy of a bank proposal](/blog/anatomy-of-a-bank-proposal-kenya).
...
**Ask early.** A borrower proposing a restructure while performing is a business managing itself. The same conversation after a covenant breach, a declined increase, or arrears is a workout. The facts are identical; the outcomes are not, and the difference in pricing and appetite is real. More on the mechanics in [debt consolidation and refinancing](/blog/debt-consolidation-refinancing-kenya).
...
- [The Anatomy of a Bank Proposal](/blog/anatomy-of-a-bank-proposal-kenya) for preparing the ask.
- [How to Read Financial Statements](/blog/how-to-read-financial-statements-kenya) and [the seven ratios](/blog/sme-financial-ratios-kenya) for diagnosing the underlying business.
- [The Revised Risk-Based Credit Pricing Model](/blog/risk-based-credit-pricing-kesonia-cbr-kenya) for why revolving facilities sit outside the new transparency rules.

### References

- [Central Bank of Kenya](https://www.centralbank.go.ke/). Banking sector lending rates and the risk-based credit pricing framework, including the treatment of revolving facilities.
- [Total Cost of Credit portal](https://www.costofcredit.co.ke/). Published pricing disclosures for covered facilities, useful when comparing a term restructure against an existing overdraft.
- [Kenya Bankers Association](https://www.kba.co.ke/). Industry practice on business lending facilities.
