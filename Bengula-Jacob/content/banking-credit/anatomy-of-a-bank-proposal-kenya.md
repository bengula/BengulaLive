---
id: anatomy-of-a-bank-proposal-kenya
title: "The Anatomy of a Perfect Bank Proposal: What Your RM Looks For Before Approving a KES 10M Facility"
summary: "A credit file is a story told in numbers, and the relationship manager reading yours is asking one question the whole time: will this business generate enough cash to repay, and what happens if it does not? This guide walks the proposal from the other side of the desk, the 5 C's of credit, the debt service cover ratio that decides most files, matching the facility to your cash cycle, and the narrative that turns a maybe into a yes."
...
```mermaid
flowchart TD
    A[Business submits proposal + documents] --> B[RM reviews and stress-tests the file]
    B --> C{Complete and bankable?}
    C -->|No| D[Back to business for gaps]
    D --> B
    C -->|Yes| E[Credit analysis: spreading, ratios, DSCR]
    E --> F[Credit committee reviews the risk]
    F --> G{Decision}
    G -->|Approved| H[Offer letter, terms, security perfection]
    G -->|Declined| I[Reasons issued]
    H --> J[Facility disbursed]
```
...
- Bengula Inc: [How Kenyan Banks Price Your Loan](/blog/how-kenyan-banks-price-loans), [Why Your RM Is Your Growth Asset](/blog/why-rm-is-sme-growth-asset), [The Complete SME Finance Handbook](/blog/sme-finance-handbook-kenya), [The Ultimate Guide to Banking in Kenya](/blog/ultimate-guide-to-banking-in-kenya), [How to Build an Accurate Startup Budget](/blog/how-to-build-an-accurate-startup-budget), [What Is Accounts Receivable](/blog/what-is-accounts-receivable), [The 13-Week Cash Forecast](/blog/13-week-cash-forecast-kenya-sme).
