...
title: "MiCA Regulation Overview: What Europe's Crypto Rulebook Means for Digital Finance"
summary: A practical guide to the EU Markets in Crypto-Assets regulation, why it matters for crypto platforms, stablecoins, investor protection, and Kenyan digital-finance literacy.
...
1. **Authorisation:** Does the provider need a licence before serving customers?
2. **Disclosures:** Must token issuers explain risks, rights, reserves, and governance?
3. **Custody:** Are client assets protected from the provider's own balance sheet?
4. **Market abuse:** Are manipulation, insider dealing, and misleading promotions addressed?
5. **Consumer redress:** Is there a complaint process if something goes wrong?
...
- [Regulation (EU) 2023/1114 on Markets in Crypto-Assets, EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32023R1114)
- [ESMA MiCA interactive single rulebook](https://www.esma.europa.eu/publications-and-data/interactive-single-rulebook/mica)
- [Council of the EU: how the EU is regulating crypto-assets](https://www.consilium.europa.eu/en/policies/crypto-assets-how-the-eu-is-regulating-markets/)
- [Kenya Virtual Asset Service Providers Act, 2025](https://new.kenyalaw.org/akn/ke/act/2025/20)
- [Central Bank of Kenya public notice on virtual currencies such as Bitcoin](https://www.centralbank.go.ke/images/docs/media/Public_Notice_on_virtual_currencies_such_as_Bitcoin.pdf)
