---
id: bank-vs-sacco-vs-mmf-savings
title: "Bank Account vs SACCO vs MMF vs Insurance: Where Should Your Savings Actually Sit?"
summary: The four places Kenyans park money serve four different jobs, and most savers use the wrong one for the job at hand. This decision guide compares banks, SACCOs, money market funds, and endowment plans on return, liquidity, protection, and credit access, shows the top performer in each category against what a typical saver actually earns, and gives a framework for splitting money across them.
...
$$ \text{Net Return} = \text{Gross Rate} \times (1 - 0.15) \quad \Rightarrow \quad 8.835\% \times 0.85 = 7.51\% $$

The gap between the savings account and the MMF on KES 100,000 is about KES 4,800 in a single year, roughly the ledger fees savers fight over, lost silently to placement rather than charges. On a KES 1 million emergency fund the same gap is KES 48,000 a year. This is the quiet leak described in [Sleeping Asset Optimization](/blog/sleeping-asset-optimization).
...
|---|---|---|---|
| Money market fund | [Nabo Africa MMF](https://www.sentill.africa/blog/best-money-market-funds-kenya-2026) | ~13.2% effective annual (Jun 2026) | Industry average ~9.1% |
| SACCO dividend | [Nyati DT SACCO](https://www.money254.co.ke/post/saccos-with-the-highest-dividends-in-2026-as-announced-so-far-investments) | 21% on share capital, 11.3% on deposits (FY2025) | Deposit interest commonly 7-11%; dividends on a small share-capital base |
| Fixed deposit | [Credit Bank](https://serrarigroup.com/ke/fd/) | ~13.2-13.6% (2026 tariff) | CBK industry average 6.8% |
| Endowment plan | [APA Akiba Halisi](https://www.apainsurance.org/product_detail_life_akiba_halisi) (representative; no league table exists) | Guaranteed payouts total 100% of sum assured, plus non-guaranteed bonuses | Effective yields typically low-to-mid single digits at maturity |
...
**Goal money (FD or MMF, by term).** For a fixed date under a year away, compare the FD rate your bank offers against the MMF's net yield and take the better number; negotiate the FD rate rather than accepting the tariff sheet. For group money, the same ladder logic applies and is covered in [The Complete Chama Guide](/blog/complete-chama-guide-kenya).
...
Money beyond these jobs is investment capital, not savings, and belongs further up the ladder: T-bills and bonds bought directly ([Kenyan Treasury Bonds Guide](/blog/kb-bond-guide-2026)), or a blended income portfolio ([Monthly Income Engine](/blog/monthly-income-engine-kenya)).
...
- **SACCO:** guarantor exposure can exceed everything you saved; shares are close to unsellable; governance quality varies widely, and SASRA's recent licensing rounds have flagged and restricted non-compliant societies. Read [Safe for Savers, Risky for Guarantors](/blog/sacco-savers-guarantors) before signing as guarantor for anyone.
...
1. **Is the float funded?** One month of spending in the current account. If not, top it up and stop there.
2. **Is the emergency fund at three months?** If not, the next shilling goes to the MMF. Nothing else matters until this exists.
3. **Does anyone depend on your income?** If yes, buy protection next, as pure term cover, priced separately from your savings. Only bundle it into an endowment if the lock-in and premium relief are worth more to you than the yield and access you give up.
4. **Will you borrow within three years?** If yes, build SACCO deposits toward the multiplier you need. If no, skip the SACCO entirely.
5. **Is there a dated goal under a year away?** Best net rate wins: negotiated FD vs MMF.
6. **Everything after that** is investment capital: ladder it into T-bills, bonds, or income assets rather than leaving it in any of the four savings homes.
...
- [Central Bank of Kenya](https://www.centralbank.go.ke/): published indicative rates (savings, deposit, T-bill), 2 July 2026.
- [Kenya Deposit Insurance Corporation](https://kdic.go.ke): deposit coverage of KES 500,000 per depositor per institution.
- [SACCO Societies Regulatory Authority (SASRA)](https://www.sasra.go.ke/): SACCO licensing and supervision.
- [Capital Markets Authority](https://www.cma.or.ke/): regulation of collective investment schemes, including MMFs.
- [Insurance Regulatory Authority](https://www.ira.go.ke): licensing of life insurers and endowment products.
- [Best Money Market Funds in Kenya 2026, Sentill Africa](https://www.sentill.africa/blog/best-money-market-funds-kenya-2026): MMF league table, June 2026.
- [SACCOs With the Highest Dividends in 2026, Money254](https://www.money254.co.ke/post/saccos-with-the-highest-dividends-in-2026-as-announced-so-far-investments): FY2025 dividend announcements.
- [Best Fixed Deposit Rates Kenya 2026, Serrari Group](https://serrarigroup.com/ke/fd/): FD rate comparator.
- [A Comprehensive Guide on Endowment Policies in Kenya, Laren Insurance](https://www.lareninsurance.co.ke/blog/a-comprehensive-guide-on-endowment-policies-in-kenya-the-two-in-one-plan-for-saving-and-life-cover): endowment mechanics, bonuses, and surrender terms.
- [Anticipated Savings Plan (Akiba Halisi), APA Life](https://www.apainsurance.org/product_detail_life_akiba_halisi): the published benefit structure used in the worked example.
- [Wealth Builder Plan, APA Life](https://www.apainsurance.org/product_investment_wb): the deposit-style plan checked against the short-tenure sales pitch.
- Bengula Inc: [The Ultimate Guide to Investing in Kenya](/blog/ultimate-guide-to-investing-in-kenya), [Ultimate Guide to Banking in Kenya](/blog/ultimate-guide-to-banking-in-kenya), [Safe for Savers, Risky for Guarantors](/blog/sacco-savers-guarantors), [The Future of MMFs in Kenya](/blog/future-mmfs-kenya), [Sleeping Asset Optimization](/blog/sleeping-asset-optimization), [The Complete Chama Guide](/blog/complete-chama-guide-kenya), [Monthly Income Engine](/blog/monthly-income-engine-kenya)
