---
id: best-pitch-deck-examples-startups
title: "Best Pitch Deck Examples from Startups: What They Did Right"
summary: Twenty pitch decks that raised billions, dissected slide by slide. What Airbnb, Coinbase, Revolut, Brex, and 16 others got right, what they missed, and the one lesson from each deck that applies to your raise.
...
Most founders build decks in the wrong order, they start with what they have (a product, a team, a market size estimate) and arrange it into slides. What investors actually read is a narrative: one argument, building across ten to fifteen slides, that answers a single question, _why this, why now, why you?_
...
![](https://www.slideshare.net/slideshow/embed_code/key/4dpBt4w6J5whJZ "airbnb-first-pitch-deck-editable from Malcolm Lewis")

Airbnb is a platform for booking rooms with locals rather than hotels. Their original 11-slide deck is one of the most studied in startup history.
...
![134](https://www.slideshare.net/slideshow/embed_code/key/ns8gcypQTWIeal "facebook-pitch-deck-87761364 from startuphome")

Facebook's original 2004 pitch was a media kit, not a traditional investor deck. It had no revenue to show, so it bet entirely on user engagement data.
...
![](https://www.slideshare.net/slideshow/embed_code/key/260BScydbD4mUf)

Coinbase is a digital currency trading platform. At the time of their seed pitch, cryptocurrencies were unknown to most investors, the deck had to explain an entirely new category before it could sell a company.
...
![](https://www.slideshare.net/slideshow/embed_code/key/oYFc7hOtsBf9Si)

BuzzFeed is an internet media company with 17.2 million YouTube subscribers and $496 million in investor funding before acquisition.
...
![](https://www.slideshare.net/slideshow/embed_code/key/eE4LgSjau9TjfF)

Tinder, originally called Match Box, used a single fictional user, "Matt," to walk investors through the product experience across 10 slides.
...
![](https://www.slideshare.net/slideshow/embed_code/key/l2fhSGkuKAgI0n)

Castle is a niche real estate solution for rental property owners with the tagline: "Put Your Properties On Autopilot."
...
![](https://www.slideshare.net/slideshow/embed_code/key/CbuIohJKKg4hfa)

LinkedIn's Series B deck explained the internet's evolution, Web 1.0 vs Web 2.0, to place professional networking in a historical context investors already understood.
...
![](https://www.slideshare.net/slideshow/embed_code/key/pdXY4qIjLvST7e)

TeaLet uses blockchain technology to connect wholesale tea buyers and retailers, cutting out the middlemen who reduce farmer earnings and consumer quality.
...
![](https://www.slideshare.net/slideshow/embed_code/key/3Lcob21rB2D6qq)

Mixpanel, founded by Suhail Doshi and Tim Treffren, helps businesses track how people consume data and draw actionable lessons from behaviour.
...
![](https://www.slideshare.net/slidebean/uber-pitch-deck)
...
![](https://www.slideshare.net/slidebean/wework-pitch-deck)
...
![](https://www.slideshare.net/DanielleMorrill/mattermark-2nd-final-series-a-deck-as-filed)
...
![](https://www.slideshare.net/slidebean/dwolla-pitch-deck)
...
![](https://www.slideshare.net/eoghanmccabe/intercom-first-pitch-deck)
...
![](https://www.slideshare.net/slidebean/brex-pitch-deck)
...
![](https://www.slideshare.net/slidebean/monzo-pitch-deck)
...
![](https://www.slideshare.net/slidebean/oscar-health-pitch-deck)
...
![](https://www.slideshare.net/slidebean/square-pitch-deck)
...
- [Airbnb Pitch Deck, Slideshare](https://www.slideshare.net/PitchDeckCoach/airbnb-first-pitch-deck-editable)
- [Facebook Original Pitch Deck, Slideshare](https://www.slideshare.net/startuphome/facebook-original-pitch-deck-87761011)
- [Coinbase Seed Round Pitch Deck, Brian Armstrong](https://www.slideshare.net/BrianArmstrongCEO/coinbase-pitch-deck)
- [TransferWise Initial Pitch Deck, Ch Daniel](https://www.slideshare.net/ChDaniel1/transferwise-56k-vc-investment-turned-into-35b-transferwises-initial-pitch-deck)
