---
id: business-valuation-kenya-guide
title: "Business Valuation in Kenya: What Your Company Is Actually Worth, and Who Decides"
summary: Every SME owner eventually needs a number, for an investor, a partner exit, a buyer, a divorce, or a succession. This guide covers the four valuation methods and when each applies, the normalisation step that changes everything, what actually moves a Kenyan SME's multiple, a worked valuation from raw accounts to a defensible range, and the checklist that builds value years before anyone asks.
...
$$ \text{Indicative Range} = 3{,}000{,}000 \times (2.5 \text{ to } 4) = \text{KES } 7.5\text{M to } 12\text{M} $$

What moves a business along that range, in the order buyers actually weigh it:

| Multiple Driver | Toward 2.5x (or below) | Toward 4x (or above) |
|---|---|---|
| Owner dependence | The founder is the business | Systems and staff run without them |
| Customer concentration | One buyer is 60% of sales | No customer above 15% |
| Revenue quality | Walk-in, tender-by-tender | Contracts, repeat cycles, subscriptions |
| Records | The books are a reconstruction | An outsider can audit in a week |
| Transferability | Licences, leases, and relationships personal to the owner | All assignable, documented |
| Sector weather | Declining or regulation-threatened | Growing, defensible |
...
Where the number funds a deal rather than settles one, remember valuation's siblings: the [capital-raising ladder](/blog/how-to-raise-startup-capital-kenya) (where the pre-money valuation decides your dilution), partner buyouts (where the [chama and partnership exit clauses](/blog/complete-chama-guide-kenya) predetermine the fight), and succession (where an unvalued business becomes an unpriced inheritance dispute).
