---
id: rental-income-yield-tax-kenya
title: "Rental Income in Kenya: Gross Yield, Net Yield, Tax, and Vacancies"
summary: "A rented flat looks like a salary that arrives without you working, until you subtract the empty months, the repairs, the agent, the insurance, and a tax charged on your gross rent rather than your profit. This guide runs the full gross-to-net waterfall on a Kenyan rental, explains the Monthly Rental Income tax, and answers the question every landlord should ask before buying: is this actually better than a bond ladder?"
...
coverImage: https://images.pexels.com/photos/17639682/pexels-photo-17639682.jpeg?auto=compress&cs=tinysrgb&w=1600
---

![A residential home at dusk](https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&cs=tinysrgb&w=1200 "The rent is the number on the wall. The yield is what is left after the empty months, the repairs, the agent, and a tax charged on the gross. They are rarely close. Photo: Pexels")
...
```mermaid
flowchart LR
  A["Gross rent<br/>KES 480,000 (8.0%)"] --> B["Less vacancy"]
  B --> C["Less agency, repairs,<br/>insurance, rates"]
  C --> D["Net operating income<br/>KES 320,000"]
  D --> E["Less tax on gross rent"]
  E --> F["Net income<br/>KES 287,000 (4.8%)"]
```
...
![A laptop, calculator, and financial papers on a desk](https://images.pexels.com/photos/6693655/pexels-photo-6693655.jpeg?auto=compress&cs=tinysrgb&w=1200 "Every landlord should build this waterfall before buying, not after the first void month teaches it to them. The net line is the only one worth a decision. Photo: Pexels")
...
![Coins and a calculator representing yield planning](https://images.pexels.com/photos/259065/pexels-photo-259065.jpeg?auto=compress&cs=tinysrgb&w=1200 "The honest test is boring arithmetic: net rental yield against a tax-free bond. If the property only wins on appreciation you have not yet earned, say so before you buy. Photo: Pexels")
