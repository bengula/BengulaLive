---
id: foreign-etfs-offshore-investing-kenya
title: "Foreign ETFs and Offshore Investing From Kenya: Buying the World From Nairobi"
summary: Every other Kenyan asset shares one risk, Kenya itself. Foreign ETFs are the fix, and the access problem is solved, with platforms routing shillings into global index funds from KES 5,000. This guide covers how the platforms work, the three fee layers to read, the currency effect that can dominate any single year, which funds actually make sense, and the tax and estate wrinkles nobody mentions at signup.
...
Foreign ETFs are the one asset class in the [Bengula investing map](/blog/ultimate-guide-to-investing-in-kenya) that fixes this, and the decade-old excuse, that global markets were for the wealthy, is dead. Licensed platforms now route M-Pesa money into world index funds from around KES 5,000, with onboarding no harder than an MMF's.
...
Whichever route: verify the local entity's licence on the [CMA register](https://www.cma.or.ke/), and understand who actually holds your assets (segregated custody with a recognised custodian is the phrase to look for in the fine print).
...
| Layer | What It Is | Typical Range | Where It Hides |
|---|---|---|---|
| Fund fee (TER) | The ETF's own annual cost | 0.03-0.5% for index funds | Inside the fund's price |
| Platform fee | The app's management/advisory charge | 0.5-1.5% annually on some platforms | The schedule, not the homepage |
| FX conversion | Shillings to dollars and back | 1-3% per direction, spread plus fees | The exchange rate you are given |

$$ \text{Your Return} = \text{Index Return} - \text{TER} - \text{Platform Fee} - \text{FX Costs (annualised)} $$
...
For long-horizon money, after the Kenyan foundations in [the cornerstone guide](/blog/ultimate-guide-to-investing-in-kenya) are built:
...
- [How to Invest in Index Funds in Kenya, Ndovu](https://www.ndovu.co/post/how-to-invest-in-index-funds-in-kenya): local platform access and minimums.
- [A Guide to ETFs in Kenya, Kenyan Wallstreet](https://kenyanwallstreet.com/a-guide-to-exchange-traded-funds-etfs-in-kenya-2025): the ETF landscape from a Kenyan vantage.
- [Capital Markets Authority](https://www.cma.or.ke/): licence verification for local platforms.
- [Central Bank of Kenya](https://www.centralbank.go.ke/): USD/KES reference rates.
- Bengula Inc: [The Ultimate Guide to Investing in Kenya](/blog/ultimate-guide-to-investing-in-kenya), [How to Buy Shares on the NSE](/blog/how-to-buy-shares-nse-kenya), [How to Invest in Gold in Kenya](/blog/how-to-invest-in-gold-kenya), [Bank Account vs SACCO vs MMF vs Insurance](/blog/bank-vs-sacco-vs-mmf-savings)
