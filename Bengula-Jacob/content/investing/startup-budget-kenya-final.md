---
id: how-to-build-an-accurate-startup-budget
title: "How to Build an Accurate Startup Budget in Kenya"
summary: Most startup budgets fail because founders guess instead of building from real numbers. This guide covers fixed costs, variable costs, three-scenario planning, cash flow discipline, and the monthly habit that separates businesses that survive from those that don't.
...
coverImage: https://images.pexels.com/photos/1181435/pexels-photo-1181435.jpeg?auto=compress&cs=tinysrgb&w=1600
---
...
[At least 61% of small businesses operate without a written budget at all.](https://smallbiztrends.com/2018/11/small-business-budget-statistics.html) That figure is not surprising. Building a budget feels like planning for a future you can't see. But a budget isn't a prediction, it's a discipline. It tells you where you are, not just where you hope to go.
...
- Loan repayments, if any. If borrowing is part of the plan, understand [how Kenyan banks price loans](/blog/how-kenyan-banks-price-loans) before you sign, and compare against [asset finance](/blog/asset-finance-vs-conventional-loans) for equipment purchases.
...
$$ \text{Runway (months)} = \frac{\text{Cash at Bank}}{\text{Net Monthly Burn}} = \frac{600{,}000}{150{,}000} = 4 \text{ months} $$

A business holding KES 600,000 against a net monthly burn of KES 150,000 has four months to fix the problem. Less than three months of runway means every decision becomes a desperate one. That's when you need to act, not after the fact. The biggest input to that forecast is usually money customers owe you; [What Is Accounts Receivable](/blog/what-is-accounts-receivable) explains how collection discipline decides whether a profitable business actually has cash.

Understanding how to structure your banking to support cash flow is covered in Bengula's [Ultimate Guide to Banking in Kenya](/blog/ultimate-guide-to-banking-in-kenya), particularly the section on high-velocity current accounts and sweep structures.
...
Track every shilling against a category from day one, even informally in a spreadsheet. Founders who can answer "where did last month's money go" within sixty seconds run tighter businesses than founders with prettier financial models. When the business outgrows the spreadsheet, graduate to a live view of sales, margin, and cash; [Retail Data & Decision Dashboard](/blog/retail-data-decision-dashboard) shows what that looks like in practice for a multi-branch trader.
