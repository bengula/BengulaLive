---
id: best-backgrounds-for-pitch-decks
title: "Best Backgrounds for Pitch Decks: What Works and What Kills the Deal"
summary: The wrong background kills a pitch deck before a single slide is read. The right one makes investors lean in. This guide covers the principles behind effective pitch deck backgrounds, the six background types that work, the six that kill pitches, and where to find professional assets for free.
...
coverImage: https://images.pexels.com/photos/3184296/pexels-photo-3184296.jpeg?auto=compress&cs=tinysrgb&w=1600
---
...
**The Airbnb approach.** Their original seed deck used a clean white background throughout. No design complexity. Every pixel of attention went to the content, and the company went on to raise $4.4 billion. See Bengula's [Best Pitch Deck Examples from Startups](/blog/best-pitch-deck-examples-startups) for the full dissection.
...
**The overlay rule.** Apply a dark overlay at 50-70% opacity before placing any text. The photograph should be barely visible beneath the content layer, not competing with it. [Unsplash](https://unsplash.com) and [Pexels](https://pexels.com) offer high-resolution professional photography for free, with no attribution requirement.
...
| Background Type | Example in Practice | Best For |
|---|---|---|
| 1. Solid dark | White headline on dark navy: "Farmers lose 40% of yield in transit" | Problem, closing, title |
| 2. Gradient | Violet-to-blue wash behind the company name, no body text | Title, section dividers |
| 3. Geometric pattern | Faint violet dot grid (under 10% opacity) behind "TAM: KES 800B" | Market, product |
| 4. Photo + dark overlay | Farm photograph under a 60% dark overlay, carrying "$330B credit gap in Africa" | Problem, opening slide |
| 5. Brand split | Violet left panel labelled "Traction", white right panel carrying "1,200 paying customers" | Traction, team, ask |
| 6. Dark premium | "KES 14.5M ARR, +180% YoY" in a bright accent colour on near-black | Financials, data slides |
...
| Background | Text Colour | Contrast Ratio | WCAG AA |
|---|---|---|---|
| Dark navy `#1E293B` | White | 15.3:1 | Pass |
| White `#FFFFFF` | Black | 21:1 | Pass |
| Bengula Violet `#5B21B6` | White | 7.5:1 | Pass |
| Mid grey `#9CA3AF` | White | 2.8:1 | Fail |
| Yellow `#FBBF24` | White | 1.9:1 | Fail |
...
**Brand colours used incorrectly.** Your brand colour as the full slide background behind black text when the contrast ratio is insufficient. Always check colour contrast ratios before finalising. [WebAIM's contrast checker](https://webaim.org/resources/contrastchecker/) flags failing combinations.

---

### Where to Find Professional Background Assets for Free

**[Unsplash](https://unsplash.com).** High-resolution photography. Free for commercial use with no attribution required. Search by industry, emotion, or subject. Download at full resolution.

**[Pexels](https://pexels.com).** Same model as Unsplash. Extensive library of business, technology, agriculture, and finance photography relevant to Kenyan startup contexts.

**[Canva](https://canva.com).** Free tier includes professional presentation templates with pre-built background systems. Pitch deck templates on Canva are designed to the right aspect ratio (16:9) and include consistent background logic across all slide types.

**[Google Slides Theme Builder](https://slides.google.com).** Build a custom theme with your brand colours and set it as the default for all slides. Every new slide inherits the background automatically. No per-slide design decisions.

**[Coolors](https://coolors.co).** Generates harmonious colour palettes from a starting colour. Useful for building a background and accent colour system around your brand primary.

**[WebAIM Contrast Checker](https://webaim.org/resources/contrastchecker/).** Paste your background and text hex codes. Confirms whether the contrast ratio meets accessibility standards.
...
- [Canva Pitch Deck Templates](https://canva.com)
- [Coolors Colour Palette Generator](https://coolors.co)
- Bengula Inc: [How to Create a Pitch Deck Narrative](/blog/how-to-create-a-pitch-deck-narrative), [Best Pitch Deck Examples from Startups](/blog/best-pitch-deck-examples-startups), [How Long Does It Take to Make a Pitch Deck?](/blog/how-long-does-it-take-to-make-a-pitch-deck)
