...
$$ \text{Net Yield} = \text{Gross Yield} \times (1 - \text{Withholding Tax}) $$

For example, if a bank offers a corporate fixed deposit rate of **9%** and a 91-day Treasury Bill yields **15.5%**:
* **Bank Fixed Deposit Net Yield:** 
  $$ 9.0\% \times (1 - 0.15) = 7.65\% $$
* **91-Day Treasury Bill Net Yield:** 
  $$ 15.5\% \times (1 - 0.15) = 13.175\% $$

On a placement of **KSh 10,000,000**, the interest earned over 91 days under both scenarios is:
* **Bank Fixed Deposit Interest:** 
  $$ \text{KSh 10,000,000} \times 7.65\% \times \frac{91}{365} \approx \text{KSh 190,725} $$
* **91-Day Treasury Bill Interest:** 
  $$ \text{KSh 10,000,000} \times 13.175\% \times \frac{91}{365} \approx \text{KSh 328,472} $$
...
| **KDIC Protection** | Capped at KSh 500,000 | Full Sovereign Guarantee |
...
- [Kenyan Treasury Bonds Demystified: Building an IFB Ladder in 2026](/blog/kb-bond-guide-2026). How to structure a tax-efficient long-term bond portfolio.
