...
$$ F = S \times \left( \frac{1 + i_{\text{KES}} \times \frac{d}{365}}{1 + i_{\text{USD}} \times \frac{d}{365}} \right) $$

Where:
* $F$ = Forward Rate
* $S$ = Spot Rate
* $i_{\text{KES}}$ = KES Interest Rate (typically based on Treasury Bill yields or Interbank rates)
* $i_{\text{USD}}$ = USD Interest Rate (typically based on SOFR)
...
| Feature | Forward Hedging | Spot FX (Unhedged) |
| --- | --- | --- |
| **Rate Certainty** | 100% Guaranteed | Variable (Market Dependent) |
| **Execution Cost** | Included in bank spread | Market rate spread at conversion |
| **Upside Potential** | None (Locked in) | Unlimited if currency moves in your favor |
| **Downside Risk** | None (Protected) | Unlimited if currency moves against you |
...
### Related Reading
- [SME Trade Finance & Supply-Chain Optimization in Frontier Markets](/blog/sme-trade-finance). Structure and choose between factoring, LCs, and LPO financing.
- [SME Packager Margin Optimization: Fixing the Cash-Flow Squeeze](/blog/sme-packager-optimization). Fix the underlying product pricing and cost structures that currency fluctuations disrupt.
