---
id: contractor-cash-flow-stack-kenya
title: "Contractor Cash Flow: Guarantees, Mobilisation, Progress Claims, and Retention"
summary: "A construction or supply contract can be profitable on paper and ruin the contractor who wins it, because the cash goes out long before it comes in. This guide maps the contractor's cash cycle end to end: pricing bid, performance, and advance guarantees into the margin, funding mobilisation, surviving the progress-certificate lag, and getting retention back. It stitches guarantees, LPO finance, and AGPO cash-flow tools into one operating system."
...
```mermaid
flowchart TD
  A["Bid stage<br/>Post bid bond, tender costs"] --> B["Award<br/>Post performance bond"]
  B --> C["Advance payment<br/>if any, against an advance guarantee"]
  C --> D["Mobilise<br/>Buy materials, deploy labour, set up site"]
  D --> E["Do the work<br/>Cash bleeds: wages, materials, plant"]
  E --> F["Progress claim<br/>Submit valuation for work done"]
  F --> G["Certification lag<br/>Client's team verifies and certifies"]
  G --> H["Payment<br/>Less a retention percentage held back"]
  H --> I["Repeat D to H per milestone"]
  I --> J["Practical completion<br/>Half of retention released"]
  J --> K["Defects liability period<br/>often 6-12 months"]
  K --> L["Final retention released"]
```
...
![A bank statement and calculator on a desk](https://images.pexels.com/photos/4386370/pexels-photo-4386370.jpeg?auto=compress&cs=tinysrgb&w=1200 "Every guarantee fee and every week of the funding gap is a line in the bid, or a hole in the margin. There is no third option. Photo: Pexels")
