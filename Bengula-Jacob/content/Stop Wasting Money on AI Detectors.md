...
> **Author's Note (2026):** This article was originally published in 2024 and has been updated to reflect developments in AI, higher education, and content provenance standards.At the time, the evidence already suggested that AI detectors were unreliable and prone to false positives. Since then, several developments have reinforced that conclusion.  
**Most notably**:  
  - Universities such as the University of Cape Town have discontinued the use of AI detectors because of concerns about reliability and false accusations.  - Educational organizations such as UCAS have shifted toward guidance on responsible AI use rather than attempting to prohibit AI outright.  - AI has expanded far beyond text generation and is now routinely used in software development, scientific research, medicine, education, data analysis, and creative work.  - Industry initiatives such as the Content Authenticity Initiative (CAI) and Coalition for Content Provenance and Authenticity (C2PA) have gained momentum as alternatives to statistical AI detection.  
  
While Artificial Intelligence has evolved dramatically since this article was first written, the central argument remains unchanged:  
  
**AI detectors provide probabilities, not proof.**  
  
As AI becomes increasingly integrated into education, research, software development, journalism, and creative work, transparency, accountability, and verification are likely to prove more effective than attempting to determine authorship through statistical guesswork.  
...
Students have used it to write assignments. Researchers have used it to draft papers. Businesses have used it to generate content at scale. The concern is legitimate.

The proposed solution, however, is deeply flawed.

AI detectors are often marketed as if they can determine whether a piece of content was written by a human or generated by AI. They cannot.

At best, they provide a statistical estimate based on patterns observed during training. At worst, they create a false sense of certainty that can damage careers, academic records, and reputations.
...
![ZeroGPT incorrectly identifying a 2016 CNN article as 100% AI-generated](https://media.licdn.com/dms/image/v2/D4D12AQFci9fbR2Cy_A/article-inline_image-shrink_1500_2232/article-inline_image-shrink_1500_2232/0/1711830536715?e=1782345600&v=beta&t=8CrztgFa0kQMAzEZLdInmZiaHZngVkxlSvUVR79E1xs)

_Figure 1: A CNN article published years before ChatGPT existed was classified by ZeroGPT as 100% AI-generated. The result demonstrates how confidence scores can be mistaken for evidence._
...
_Research and editorial assistance provided using OpenAI's ChatGPT._
...
- Wikipedia: Artificial Intelligence Content Detection  
    [https://en.wikipedia.org/wiki/Artificial_intelligence_content_detection](https://en.wikipedia.org/wiki/Artificial_intelligence_content_detection)

### Examples of AI Use in Academic Publishing

- Bilal Mushtaq's Examples of AI-Generated Research Papers  
    [https://twitter.com/MushtaqBilalPhD/status/1769740682632020103](https://twitter.com/MushtaqBilalPhD/status/1769740682632020103)

### AI Detector Failures

- Atheer Mahir, How AI Detectors Mistakenly Identified the Bible as AI-Generated  
    [https://www.linkedin.com/pulse/how-ai-detectors-mistakenly-identify-author-bible-atheer-mahir/](https://www.linkedin.com/pulse/how-ai-detectors-mistakenly-identify-author-bible-atheer-mahir/)
- CNN Article Used in the ZeroGPT Experiment  
    [https://www.cnn.com/2016/12/21/politics/donald-trump-hillary-clinton-popular-vote-final-count/index.html](https://www.cnn.com/2016/12/21/politics/donald-trump-hillary-clinton-popular-vote-final-count/index.html)

### AI Detector Company Statements

- Originality.ai, Most Common Reasons for False Positives  
    [https://help.originality.ai/en/article/most-common-reasons-for-false-positives-with-originality-1sf6ykc/](https://help.originality.ai/en/article/most-common-reasons-for-false-positives-with-originality-1sf6ykc/)
...
- PCMag, OpenAI Quietly Shuts Down AI Text Detection Tool Over Inaccuracies  
    [https://www.pcmag.com/news/openai-quietly-shuts-down-ai-text-detection-tool-over-inaccuracies](https://www.pcmag.com/news/openai-quietly-shuts-down-ai-text-detection-tool-over-inaccuracies)
- OpenAI, How Educators Can Respond to Students Presenting AI-Generated Content as Their Own  
...
- UCAS, AI Tools Guide  
    [https://www.ucas.com/ai-tools-guide](https://www.ucas.com/ai-tools-guide)
- University of Cape Town, UCT Scraps Flawed AI Detectors  
    [https://www.news.uct.ac.za/article/-2025-07-24-uct-scraps-flawed-ai-detectors](https://www.news.uct.ac.za/article/-2025-07-24-uct-scraps-flawed-ai-detectors)
- Marian University, AI Detection Tools Overview  
    [https://libguides.marian.edu/c.php?g=1321167&p=9721351](https://libguides.marian.edu/c.php?g=1321167&p=9721351)
